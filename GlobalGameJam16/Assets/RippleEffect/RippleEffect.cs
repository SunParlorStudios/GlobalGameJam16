...
public class RippleEffect : MonoBehaviour
{
    ...
    void UpdateShaderParameters()
    {
        ...
        material.SetVector("_Params1", new Vector4(1.77777777777778f, 1, 1 / waveSpeed, 0));
        material.SetVector("_Params2", new Vector4(1, 1 / 1.77777777777778f, refractionStrength, reflectionStrength));
    }
